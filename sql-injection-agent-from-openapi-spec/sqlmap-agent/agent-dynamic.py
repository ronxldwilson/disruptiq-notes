...
# ---------- DEFAULT CONFIG ----------
DEFAULT_OPENAPI_FILE = '../team-LECture-bot/api/openapi.yaml'
...
def main_cli():
    ...
    servers = spec.get('servers', [{'url': 'http://localhost:5432'}])
    server_url = servers[0].get('url', 'http://localhost:5432')
    if args.server_url:
